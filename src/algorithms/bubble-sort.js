(() => {
    ...
    const bubbleSortContainer = document.createElement('section');
    bubbleSortContainer.className = 'bubble-sort';

    const tittle = document.createElement('h1');
    tittle.innerText = 'Bubble sort algorithm';
    ...
    const onStartSort = () => {
        ...
        bubbleSortContainer.appendChild(resultDiv);
    };

    button.addEventListener('click', onStartSort);

    bubbleSortContainer.appendChild(tittle);
    bubbleSortContainer.appendChild(firstRow);
    genButtonsDiv.appendChild(genButton);
    genButtonsDiv.appendChild(genSmallButton);
    genButtonsDiv.appendChild(genFewButton);
    bubbleSortContainer.appendChild(genButtonsDiv);
    bubbleSortContainer.appendChild(button);
    rootDiv.appendChild(bubbleSortContainer);
